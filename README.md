...
[![Maven](https://img.shields.io/maven-central/v/io.taig/gandalf_2.11.svg)](http://search.maven.org/#artifactdetails%7Cio.taig%7Cgandalf_2.11%7C0.3.2%7Cjar)
...
````scala
libraryDependencies ++=
    "io.taig" %% "gandalf-core" % "0.3.2" ::
    "io.taig" %% "gandalf-predef" % "0.3.2" ::
    "io.taig" %% "gandalf-report" % "0.3.2" ::
    "io.taig" %% "gandalf-android" % "0.3.2" ::
    Nil
````